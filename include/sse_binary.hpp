...
struct SseBinary : public codec::BinaryCodec {
    ...
    void decode(ByteBuf& buf) override {
        ...
        switch (msgType) {
            case 33:
                body = std::make_unique<Heartbeat>();
                break;
            case 40:
                body = std::make_unique<Logon>();
                break;
            case 41:
                body = std::make_unique<Logout>();
                break;
            case 58:
                body = std::make_unique<NewOrderSingle>();
                break;
            case 61:
                body = std::make_unique<OrderCancel>();
                break;
            case 32:
                body = std::make_unique<Confirm>();
                break;
            case 59:
                body = std::make_unique<CancelReject>();
                break;
            case 103:
                body = std::make_unique<Report>();
                break;
            case 204:
                body = std::make_unique<OrderReject>();
                break;
            case 209:
                body = std::make_unique<PlatformState>();
                break;
            case 208:
                body = std::make_unique<ExecRptInfo>();
                break;
            case 206:
                body = std::make_unique<ExecRptSync>();
                break;
            case 207:
                body = std::make_unique<ExecRptSyncRsp>();
                break;
            case 210:
                body = std::make_unique<ExecRptEndOfStream>();
                break;
            default:
